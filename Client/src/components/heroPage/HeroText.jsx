  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center w-full z-10 pt-16 sm:pt-20 md:pt-24">
      ...
      <motion.h1
        ...
        className="text-2xl max-md:text-6xl max-sm:text-[3rem] xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-7xl  font-[nexa-bold] text-white  drop-shadow-2xl leading-none"
        style={{
      ...
      <motion.h1
        ...
        className="text-3xl xs:text-4xl max-md:text-6xl max-sm:text-[3rem]  sm:text-2xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-7xl  font-[nexa-bold] text-white drop-shadow-2xl leading-none"
        style={{
          textShadow: '2px 2px 8px rgba(0,0,0,0.8), 0px 0px 20px rgba(0,0,0,0.5)'
        }}
      >
      ...
      <motion.h1
        ...
        className=" text-2xl xs:text-3xl max-md:text-6xl max-sm:text-[3rem]  sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-7xl   font-[nexa-bold] text-white drop-shadow-2xl leading-none"
        style={{
          textShadow: '2px 2px 8px rgba(0,0,0,0.8), 0px 0px 20px rgba(0,0,0,0.5)'
        }}
      >
